...
in
{
  programs.waybar.settings.mainBar = with custom; {
    ...
    "hyprland/language" = {
      ...
      format = "<span foreground='${text_color}'> </span> {}";
      format-en = "US";
    ...
    "custom/notification" = {
      ...
      format = "{icon}";
      format-icons = {
        notification = "<span foreground='${text_color}'><sup></sup></span>";
        none = "";
        dnd-notification = "<span foreground='${text_color}'><sup></sup></span>";
        dnd-none = "";
        inhibited-notification = "<span foreground='${text_color}'><sup></sup></span>";
        inhibited-none = "";
        dnd-inhibited-notification = "<span foreground='${text_color}'><sup></sup></span>";
        dnd-inhibited-none = "";
      };
      return-type = "json";
