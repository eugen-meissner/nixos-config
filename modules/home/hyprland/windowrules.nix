{ ... }:
{
  wayland.windowManager.hyprland.settings = {
    ...
    # Layer rules: use match:namespace for 0.53+
    layerrule = [
      "dimaround, match:namespace vicinae"
      "dimaround, match:namespace rofi"
      "dimaround, match:namespace swaync-control-center"
    ];
