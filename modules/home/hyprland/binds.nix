{ ... }:
{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "ALT, Return, exec, [float; size 1111 700] foot"
      "$mainMod SHIFT, Return, exec, [fullscreen] foot"
      "$mainMod, B, exec, [workspace 1 silent] env MOZ_ENABLE_WAYLAND=1 zen-beta"
      ...
      "$mainMod, E, exec, foot -e superfile"
